...
struct MockExtractionService: ExtractionService {
    ...
    func streamDetails(id: String) async throws -> (stream: StreamItem, formats: [VideoFormat], related: [StreamItem]) {
        ...
        let formats: [VideoFormat] = [
            VideoFormat(kind: .muxed, url: URL(string: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4")!, itag: 18, label: "360p · mp4"),
            VideoFormat(kind: .muxed, url: URL(string: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4")!, itag: 22, label: "720p · mp4"),
